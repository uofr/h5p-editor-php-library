H5PEditor.language.core = {
  ...
  commandKey: '⌘',
  pasteKey: 'v',
  supportedVideoFormats: 'H5P supports the following external video sources: <span class="h5p-bold">Youtube</span>, <span class="h5p-bold">Kaltura</span>, <span class="h5p-bold">Panopto</span> and <span class="h5p-bold">Vimeo</span>.',
  ...
  addVideoDescription: 'H5P supports all external video sources formatted as mp4, webm or ogv, like Vimeo Pro, and has support for YouTube, Kaltura and Panopto links.',
